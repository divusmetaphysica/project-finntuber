<template>
  <div class="page">
    ...
    <p>
      ...
      volunteer project created by the Fintuber community and the fans. Our aim
      is to help you better discover streamers for you to enjoy.
    </p>
    ...
    <p>
      ...
      While the term originates from Youtube, it is nowadays used of all virtual
      streamers regardless of their streaming platform. Sometimes you may also
    ...
    <p>
      ...
      speak Finnish and/or live in Finland. So, you don't have to tick all three
      boxes - if you identify with being Finnish in some way, that's enough! As
      for the VTuber part, everyone who streams using an avatar instead of a
      facecam counts. We also have people who mix both VTuber and facecam
      streams, so as long as a considerable amount of your content is created
      using an avatar and you identify as a VTuber, you can be added to the
      list.
    </p>
    ...
    <p>
      ...
      page. Message one of us and we'll get you added, and connect you with the
      rest of the community if you want!
    </p>
  </div>
</template>
